    - [3. 해결 방안 : `useState`로 미리보기 화면에 블럭을 선택한 상태를 전달](#3-%ED%95%B4%EA%B2%B0-%EB%B0%A9%EC%95%88--usestate%EB%A1%9C-%EB%AF%B8%EB%A6%AC%EB%B3%B4%EA%B8%B0-%ED%99%94%EB%A9%B4%EC%97%90-%EB%B8%94%EB%9F%AD%EC%9D%84-%EC%84%A0%ED%83%9D%ED%95%9C-%EC%83%81%ED%83%9C%EB%A5%BC-%EC%A0%84%EB%8B%AC)
    - [4. 회고 및 개선 방향 : ??](#4-%ED%9A%8C%EA%B3%A0-%EB%B0%8F-%EA%B0%9C%EC%84%A0-%EB%B0%A9%ED%96%A5--)
...
![alt text](public/image/notion-content-select.png)
...
html태그를 일일이 렌더링하는 과정을 클라이언트에서 실행한다면 통신 등 환경이나 상황에 따라 온전한 렌더링이 이루어지지 않을 수도 있기에 서버에서 노션 블럭과 동일한 html파일을 렌더링하는 SSR방식으로 노션블럭을 재현했습니다.
...
마침 next.js를 제작한 Vercel에서 SSG를 생성하고 배포하는 서비스를 제공하고 있었기에 이를 통해 SSG를 생성하도록 했습니다.

## 2-3. Vercel을 활용한 서브도메인 부여

![alt text](public/image/subdomain-input.png)
...
## 3-1. 노션 데이터를 어떻게 가져오는게 최선일까?

#### <U>1. 문제정의: 꼭 노션API를 사용해야만 할까?</U>

처음에는 노션 API를 사용해 노션 페이지의 데이터를 가져오는 방식을 고려했습니다. 하지만 이 경우 극복이 어려운 단점이 있었습니다.
...
노션 페이지의 부분 배포 기능은 사용자가 특정 블럭만 선택해 웹사이트로 배포할 수 있도록 설계되었습니다. 하지만 초기 구현에서는 사용자가 개별 블럭을 하나하나 선택해야 했기 때문에, 이 과정이 번거롭고 시간이 많이 소요되는 문제가 있었습니다. 사용자에게 너무 많은 선택을 강요하는 인터페이스는 직관적이지 못하고, 배포 과정에서 불편함을 야기했습니다. 더불어 노션의 깔끔한 인터페이스는 보이지 않는 수많은 `<div>`의 덕분이었기에, 어떠한 블럭을 선택했다 하더라도 레이아웃의 역할을 하는 `<div>`였다면 아무 내용도 담기지 않는 결과 또한 발생되었습니다.

#### <U>2. 접근 방식 정의 : 노션의 계층적 블럭 구조 활용 → 상위 블럭 선택시 하위블럭까지 포함</U>
...
현재 사용자의 커스텀 도메인 정보를 Vercel 프로젝트 내에 저장하여 관리하고 있지만, 이 방식이 개인정보 보호법을 충분히 준수하고 있는지 확인이 필요합니다.

특히, 사용자가 입력한 도메인 정보가 제3자에게 유출될 위험성을 줄이기 위한 보안 조치가 필요합니다. 이러한 데이터를 안전하게 저장하고 관리하기 위해 추가적인 조사가 필요하며, 데이터를 더 안전하게 처리할 방법을 모색하고 있습니다.

#### <U>2. 개선 방안</U>

향후 업데이트에서는 도메인 데이터 암호화를 통해 사용자 정보를 더욱 안전하게 관리할 계획입니다. 이 외에도, 개인정보 보호와 관련된 법적 요구사항을 철저히 준수할 수 있도록, 향후 보안 강화를 위한 조치를 추가할 계획입니다.
