...
- [3. 챌린지](#3-%EC%B1%8C%EB%A6%B0%EC%A7%80)
  ...
  #### 모든 챌린지는 ①문제 정의 → ②접근 방식 정의 → ③해결 방안 → ④회고 및 개선방안 순으로 정리했습니다.
...
더불어 노션의 깔끔한 인터페이스는 보이지 않는 수많은 `<div>`의 덕분이었기에, 어떠한 블럭을 선택했다 하더라도 레이아웃의 역할을 하는 `<div>`였다면 아무 내용도 담기지 않는 결과 또한 발생되었습니다.
